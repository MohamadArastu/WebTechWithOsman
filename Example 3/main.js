...
class ShoppingCart {
    ...
    add(book) {
         ...
         * </li>
         */
        const ul = document.getElementById("addToShopList");
        ...
        spanQuantity.innerText = " " + book.quantity + " Pcs. - " + this.round((book.quantity * book.price));
...
class BookStore {
    ...
    addBookToDOM(category, book) {
        ...
        for (var i = 1; i <= BookStore.MAX_QUANTITY; i++) {
        ...
        input.onclick = () => {
            ...
            switch (Number.parseInt(optionValue)) {
                case 1:
